...
type Book = { id: string; title: string; author: string; shelf: string; sourcePath?: string; originalPath?: string; coverPath?: string; progress: number; lastOpenedAt?: number; noteIds: string[]; questionBookIds: string[] };
